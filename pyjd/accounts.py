...
def add_account(premium_hoster: str, username: str, password: str) -> None:
    ...
    action('/addAccount', params)


def add_basic_auth(auth_type: BasicAuthType, hostmask: str, username: str,
        password: str) -> int:
...
def disable_accounts(account_ids: List[int]) -> None:
    ...
    params = [account_ids]
    action('/disableAccounts', params)


def enable_accounts(account_ids: List[int]) -> None:
    ...
    params = [account_ids]
    action('/enableAccounts', params)


def get_premium_hoster_url(hoster: str) -> str:
...
def list_accounts(
        account_query: AccountQuery = AccountQuery()) -> List[Account]:
...
def list_basic_auth() -> List[BasicAuth]:
...
def list_premium_hoster() -> List[str]:
...
def list_premium_hoster_urls() -> Dict[str, str]:
...
def refresh_accounts(account_ids: List[int]) -> None:
    ...
    params = [account_ids]
    action('/refreshAccounts', params)


def remove_accounts(account_ids: List[int]) -> None:
    ...
    params = [account_ids]
    action('/removeAccounts', params)


def remove_basic_auths(basic_auth_ids: List[int]) -> bool:
...
def set_username_and_password(account_id: int, username: str,
        password: str) -> bool:
...
def update_basic_auth(basic_authentication: BasicAuth) -> bool:
